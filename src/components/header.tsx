...
const Header = () => {
	return (
		<header
			className='bg-background/20 border-foreground/20 sticky top-0
			z-20 flex h-20 w-full
			 flex-row items-center space-y-2 border-b-2
			 px-4 backdrop-blur-sm backdrop-hue-rotate-180'
		>
			<div className='inset-x-0 flex w-full flex-row items-center justify-between'>
				<Link
					href={'/'}
					className='header-item bg-background text-primary h-fit w-fit rounded-xl px-3 py-2'
				>
					<p
				...
				<div className='flex flex-row items-center space-x-4'>
					...
					<Link
						...
						target='_blank'
						className={
							'header-item bg-background rounded-xl px-3 py-2'
						}
					>
